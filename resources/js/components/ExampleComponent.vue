                ...
                <div class="card-body row">
                    <div class="row col-md-6">
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter1" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            <b-icon icon="server" scale="1.5"></b-icon>
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter2" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            <b-icon icon="server" scale="1.5"></b-icon>
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter3" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            <b-icon icon="server" scale="1.5"></b-icon>
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter4" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            <b-icon icon="server" scale="1.5"></b-icon>
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter5" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                        <div class="col-md-3 border border-danger text-danger text-center m-2 pt-2 rounded-lg">
                            <b-icon icon="server" scale="1.5"></b-icon>
                            ...
                            <br>
                            <div class="mb-1">
                                <vue-numeric-input v-on:change="checkValue()" v-model="counter6" :min="0" controls-type="updown" class="mt-2 w-auto"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
